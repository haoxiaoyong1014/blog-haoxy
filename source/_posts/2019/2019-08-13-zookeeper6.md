...
![image.png](https://user-gold-cdn.xitu.io/2019/8/14/16c8bd5e490db9d4?w=453&h=291&f=png&s=6284)
...
![image.png](https://user-gold-cdn.xitu.io/2019/8/14/16c8bd5e48f6b5d7?w=681&h=271&f=png&s=15403)

**2,创建Model,在Project上创建model**

![image.png](https://user-gold-cdn.xitu.io/2019/8/14/16c8bd5e49bd79c4?w=681&h=256&f=png&s=53415)

依次创建好所有的model,如图所示:

![image.png](https://user-gold-cdn.xitu.io/2019/8/14/16c8bd5e4cfe58f5?w=410&h=422&f=png&s=36374)

**3,构建模块之间的依赖关系:**

目前为止，模块之间没有任何联系，下面我们要通过pom文件来指定它们之间的依赖关系，依赖关系如下图所示：

![image.png](https://user-gold-cdn.xitu.io/2019/8/14/16c8bd5e4e8e937d?w=682&h=414&f=png&s=7038)
